...
//						  TokenRepository tokenRepository, PatientReportService patientReportService, PasswordEncoder bcryptEncoder) {
...
//				return ResponseEntity.ok().body(patient);
//			} else {
//				LOG.info("Patient could not be updated because the Patient id could not be found  : ");
//				return new ResponseEntity("Patient of this id does not exist. Please update a existing record!",
//						HttpStatus.ACCEPTED);
//			}
//
//		} catch (PropertyValueException e) {
